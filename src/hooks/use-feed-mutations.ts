...
export function useCreatePost() {
  ...
  return useMutation({
    mutationFn: (input: feedApi.CreatePostInput) =>
      feedApi.createPost(input, requireAccessToken()),
...
export function useUpdatePost() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      postId: string;
      input: Partial<feedApi.CreatePostInput>;
...
export function useDeletePost() {
  ...
  return useMutation({
    mutationFn: (postId: string) =>
      feedApi.deletePost(postId, requireAccessToken()),
    onSuccess: () => {
...
export function useLikePost() {
  ...
  return useMutation({
    mutationFn: (postId: string) =>
      feedApi.likePost(postId, requireAccessToken()),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["feed"] });
      queryClient.invalidateQueries({ queryKey: ["user-posts"] });
    },
...
export function useUnlikePost() {
  ...
  return useMutation({
    mutationFn: (postId: string) =>
      feedApi.unlikePost(postId, requireAccessToken()),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["feed"] });
      queryClient.invalidateQueries({ queryKey: ["user-posts"] });
    },
...
export function useCreateStory() {
  ...
  const showToast = useToastStore((s) => s.show);
  return useMutation({
    mutationFn: (input: feedApi.CreateStoryInput) =>
      feedApi.createStory(input, requireAccessToken()),
    onSuccess: () => {
...
export function useViewStory() {
  return useMutation({
    mutationFn: (storyId: string) =>
      feedApi.viewStory(storyId, requireAccessToken()),
  });
}
...
export function useLikeStory() {
  ...
  return useMutation({
    mutationFn: (storyId: string) =>
      feedApi.likeStory(storyId, requireAccessToken()),
    onError: (err) => showToast(friendlyErrorMessage(err)),
  });
}
