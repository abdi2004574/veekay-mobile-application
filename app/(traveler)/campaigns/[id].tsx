    ...
    <SafeAreaView className="flex-1 bg-background">
      <ScrollView contentContainerStyle={{ paddingBottom: 24 }}>
        <View style={{ position: 'relative' }}>
          ...
          <Pressable
            onPress={() => showInDevelopmentAlert('Sharing a campaign link isn’t available yet.')}
            style={{
              position: 'absolute',
              top: 16,
              right: 16,
        ...
        <View className="px-4 py-4">
          ...
          >
            ...
            <CampaignProgressBar raised={0} goal={c.goalAmount} />
            <View
            ...
            >
              ...
              <Text className="text-sm font-bold" style={{ color: colors.vaykaePink }}>
                ${c.goalAmount.toLocaleString()} to go
              </Text>
            </View>
          </View>
          ...
          {c.isCreator ? (
            // Donating to / messaging yourself doesn't make sense — Edit/Delete
            // already live on the My Campaigns list card, so offer a shortcut here.
            <Pressable
              onPress={() =>
                router.push({
            ...
            <View className="flex-row gap-3">
              <View style={{ flex: 1 }}>
                <Pressable
                  onPress={() => showInDevelopmentAlert('Donations aren’t available yet.')}
              ...
              <Pressable
                onPress={() => showInDevelopmentAlert('Saving campaigns isn’t available yet.')}
                className="w-14 h-14 rounded-2xl items-center justify-center"
                style={{ borderWidth: 2, borderColor: colors.border }}
              >
