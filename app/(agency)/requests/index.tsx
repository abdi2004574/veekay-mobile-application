...
const FILTERS: FilterCard[] = [
  ...
  },
  {
    ...
    activeText: colors.foreground,
    activeRing: "rgba(59,130,246,0.3)",
  },
  {
    key: "confirmed_or_completed",
    label: "Booked",
    activeBg: "rgba(34,197,94,0.1)",
    activeText: colors.foreground,
    activeRing: "rgba(34,197,94,0.3)",
  },
];

const SERVER_STATUS: Record<
  Exclude<FilterKey, "all" | "confirmed_or_completed">,
  TripRequestStatus
> = {
  pending: "pending",
...
export default function AgencyRequestsScreen() {
  ...
  const serverStatus =
    filter === "pending" || filter === "in_discussion"
      ? SERVER_STATUS[filter]
      : undefined;
  ...
  const counts = useMemo(() => {
    return {
      ...
      in_discussion: allItems.filter((i) => i.status === "in_discussion")
        .length,
            ...
            const inner = (
              ...
              >
                <Text
                  ...
                  style={{
                    color: isAll && isActive ? colors.background : f.activeText,
                  }}
                >
                  {count}
                </Text>
              ...
              <View className="py-16 items-center px-6">
                ...
                {filter === "all" && (
                  <Text
                    ...
                    style={{ color: colors.mutedForeground }}
                  >
                    Travelers can send you a request from your agency profile or
                    a package.
                  </Text>
                )}
              </View>
