  ...
  return (
    <LegalPageLayout title="Privacy Policy" lastUpdated="March 17, 2026">
      <LegalSection heading="1. Introduction">
        <LegalParagraph>
          Welcome to Vaykae. We respect your privacy and are committed to
      ...
      <LegalSection heading="4. Information Sharing">
        ...
        <LegalBullet>
          Travel Agencies — when you book packages or request services
        </LegalBullet>
        <LegalBullet>
          Service Providers — payment processors, hosting providers, analytics
          services
        </LegalBullet>
        <LegalBullet>
          Other Users — profile information visible on campaigns and social
          features
        </LegalBullet>
        <LegalBullet>
      ...
      <LegalSection heading="9. Children's Privacy">
        <LegalParagraph>
          Vaykae is not intended for users under 18 years of age. We do not
      ...
      <LegalSection heading="11. Data Retention">
        <LegalParagraph>
          ...
          services and comply with legal obligations. When data is no longer
