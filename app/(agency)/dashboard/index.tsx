...
} from "../../../src/hooks/use-agency-dashboard-queries";
...
export default function AgencyDashboard() {
  ...
  const isLoading =
    kpis.isLoading ||
    fundingTrends.isLoading ||
    topDestinations.isLoading ||
    travelerPreferences.isLoading;
  const isError =
    kpis.isError ||
    fundingTrends.isError ||
    topDestinations.isError ||
    travelerPreferences.isError;
      ...
      <SafeAreaView className="flex-1 bg-background" edges={["top"]}>
        <View className="flex-1 items-center justify-center px-6">
          ...
          <GradientButton
            ...
            onPress={() => {
              kpis.refetch();
              fundingTrends.refetch();
              topDestinations.refetch();
              travelerPreferences.refetch();
            }}
            className="mt-4"
          >
            Retry
      ...
      >
        ...
        <View className="p-4 space-y-6">
          ...
          <View className="bg-card border border-border rounded-2xl p-4">
            <View className="flex-row items-center justify-between mb-4">
              ...
              <RangeSelector
                ...
                onChange={
                  setRange as (
                    v: import("../../../src/components/RangeSelector").RangeOption,
                  ) => void
                }
              />
            </View>
          ...
          <View className="bg-card border border-border rounded-2xl p-4">
            ...
            <TopDestinationsBarChart
              data={destinationsData?.destinations ?? []}
            />
          ...
          <View className="bg-card border border-border rounded-2xl p-4">
            ...
            <TravelerPreferencePieChart
              data={preferencesData?.preferences ?? []}
            />
