          ...
          {isLoading ? (
            ...
            <View className="flex-1 items-center justify-center py-16 px-6">
              <View
                ...
                style={{ backgroundColor: colors.vaykaePink + "15" }}
              >
              ...
              <Pressable
                onPress={() =>
                  showInDevelopmentAlert(
                    "The funding rail for payout account updates is still being finalized. Once confirmed, this will open the Stripe Connect onboarding flow.",
                  )
                }
            ...
            <>
                ...
                >
                  ...
                  <View className="space-y-3">
                    ...
                    <AccountDetailRow
                      ...
                      value={payoutAccount.maskedAccount}
                    />
                    <Divider />
                    <AccountDetailRow
                      label="Account Type"
                    ...
                    <AccountDetailRow
                      ...
                      value={payoutAccount.routingNumber}
                    />
                    <Divider />
                    <AccountDetailRow
                      label="Last Updated"
                      value={payoutAccount.lastUpdated}
                    />
                  </View>
                </View>
              </View>
                  ...
                  <View className="flex-row items-start gap-3 mb-3">
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <Text
                        ...
                        style={{ color: colors.mutedForeground }}
                      >
                        Your payouts are processed through Stripe Connect. Funds
                        from completed bookings are automatically transferred to
                        this bank account on a rolling basis (typically 2-7
                        business days after booking completion).
                      </Text>
                    </View>
                  </View>
                  <View className="flex-row items-start gap-3">
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <Text
                        ...
                        style={{ color: colors.mutedForeground }}
                      >
                        Bank details are encrypted and stored securely by
                        Stripe. We never store your full account or routing
                        numbers.
                      </Text>
                    </View>
                  </View>
              ...
              <Pressable
                ...
                style={{
                  ...
                  backgroundColor: colors.vaykaePink + "10",
                }}
              >
                <View
                  className="w-10 h-10 rounded-xl items-center justify-center"
