...
export function getGroupOverview(campaignId: string, accessToken: string) {
  return apiFetch<GroupOverview>(`/campaigns/${campaignId}/group/overview`, {
    accessToken,
  });
}

export function listGroupMembers(campaignId: string, accessToken: string) {
  return apiFetch<GroupMember[]>(`/campaigns/${campaignId}/group/members`, {
    accessToken,
  });
}
...
export function listGroupContributions(
  campaignId: string,
  accessToken: string,
) {
  return apiFetch<GroupContribution[]>(
    `/campaigns/${campaignId}/group/contributions`,
    {
      accessToken,
    },
  );
...
export function removeGroupExpense(
  campaignId: string,
  expenseId: string,
  accessToken: string,
) {
  return apiFetch<void>(
    `/campaigns/${campaignId}/group/expenses/${expenseId}`,
    {
      method: "DELETE",
      accessToken,
    },
