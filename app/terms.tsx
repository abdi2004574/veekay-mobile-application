  ...
  return (
    <LegalPageLayout title="Terms & Conditions" lastUpdated="March 17, 2026">
      <LegalSection heading="1. Acceptance of Terms">
        <LegalParagraph>
          By accessing and using Vaykae (&quot;the Platform&quot;), you agree to
      ...
      <LegalSection heading="3. Fundraising Campaigns">
        ...
        <LegalBullet>
          Provide truthful and accurate information about your travel plans
        </LegalBullet>
        <LegalBullet>
          Use funds solely for the stated travel purpose
        </LegalBullet>
      ...
      <LegalSection heading="4. Donations">
        <LegalParagraph>
          All donations made through Vaykae are voluntary. Donors acknowledge
          that donations are non-refundable except as required by law. Vaykae is
          not responsible for how campaign creators use donated funds.
        </LegalParagraph>
      </LegalSection>
      ...
      <LegalSection heading="5. Travel Agency Services">
        ...
        <LegalBullet>
          Provide accurate package information and pricing
        </LegalBullet>
      ...
      <LegalSection heading="6. Fees and Payments">
        <LegalParagraph>
          Vaykae charges a platform fee on successful fundraising campaigns and
          travel bookings. All fees are clearly disclosed before transactions.
          Payment processing is handled by third-party providers subject to
          their terms.
        </LegalParagraph>
      </LegalSection>
      ...
      <LegalSection heading="8. Intellectual Property">
        <LegalParagraph>
          All content, features, and functionality on Vaykae are owned by Vaykae
      ...
      <LegalSection heading="9. Limitation of Liability">
        <LegalParagraph>
          Vaykae is provided &quot;as is&quot; without warranties of any kind.
          We are not liable for any indirect, incidental, or consequential
          damages arising from your use of the Platform, including travel
          disruptions, cancelled trips, or disputes between users and agencies.
        </LegalParagraph>
      </LegalSection>
      ...
      <LegalSection heading="10. Termination">
        <LegalParagraph>
          ...
          discretion. You may terminate your account at any time by contacting
          support.
        </LegalParagraph>
      </LegalSection>
      ...
      <LegalSection heading="11. Changes to Terms">
        <LegalParagraph>
          ...
          Platform after changes constitutes acceptance of the revised Terms. We
