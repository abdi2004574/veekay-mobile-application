...
import {
  useAgencyReviews,
  useMyReviews,
} from "../../../src/hooks/use-reviews-queries";
  ...
  return (
    <SafeAreaView className="flex-1 bg-background" edges={["top"]}>
      ...
      <FlatList
          ...
          <View className="mb-6">
              ...
              <Pressable
                onPress={() =>
                  showInDevelopmentAlert(
                    "Linking a fundraiser isn’t available yet.",
                  )
                }
            ...
            {!myReviewForThisAgency && (
              ...
              >
                ...
                <GradientButton
                  onPress={() =>
                    router.push(`/(traveler)/review-agency/${info.id}`)
                  }
                >
                  Write a Review
                </GradientButton>
        ...
        renderItem={({ item }) => {
          const reviewerName =
            item.reviewer.displayName ?? `@${item.reviewer.username}`;
