            ...
            onPress={() =>
              isSelf
                ...
                : router.push({
                    ...
                    params: { userId: profile.id, creatorName: name },
                  })
            }
          >
            <Text className="font-bold text-foreground">
        ...
        {isSelf ? (
          <>
            ...
            >
              ...
              <Text className="font-bold text-foreground flex-1">
                My Reviews
              </Text>
  ...
  if (isError || !profile) {
    return (
      <SafeAreaView className="flex-1 bg-background items-center justify-center px-6">
        ...
        <Pressable
          onPress={() => (isSelf ? me.refetch() : otherProfile.refetch())}
        >
