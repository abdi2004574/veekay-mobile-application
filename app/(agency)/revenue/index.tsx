...
import {
  RevenueLedgerRow,
  RevenueLedgerHeader,
} from "../../../src/components/RevenueLedgerRow";
...
import {
  useInfiniteRevenueLedger,
  useExportRevenueCsv,
} from "../../../src/hooks/use-agency-revenue-queries";
...
export default function RevenueScreen() {
  ...
  const handleExport = async () => {
    try {
      ...
      showAlert(
        "Export Failed",
        "Could not export revenue data. Please try again.",
      );
    }
  };
  ...
  const hasActiveFilters =
    isCustomRange && (customStart !== null || customEnd !== null);
      ...
      <View style={{ flex: 1 }}>
        ...
        <View className="px-4 pb-4">
          ...
          {hasActiveFilters && (
            ...
            >
              <Text style={{ color: colors.vaykaePink }}>
                Clear custom range
              </Text>
            </Pressable>
          )}
            ...
            >
              ...
              {filteredItems.length === 0 ? (
                ...
                <>
                  ...
                  <View
                    className="bg-muted px-4 py-3 border-t"
