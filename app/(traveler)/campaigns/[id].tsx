...
import {
  useCampaign,
  useTopContributors,
} from "../../../src/hooks/use-campaigns-queries";
          ...
          <Pressable
            onPress={() =>
              showInDevelopmentAlert(
                "Sharing a campaign link isnt available yet.",
              )
            }
            style={{
              position: "absolute",
        ...
        <View className="px-4 py-4">
          <Pressable
            onPress={
              c.isCreator
                ? undefined
                : () => router.push("/(traveler)/user/" + c.creator.id)
            }
          ...
          {c.isCreator ? (
              ...
              onPress={() =>
                router.push({
                  ...
                  params: {
                    ...
                    editTripEndDate: c.tripEndDate
                      ? c.tripEndDate.slice(0, 10)
                      : "",
                    editStory: c.story ?? "",
            ...
            <View className="flex-row gap-3">
              ...
              <Pressable
                onPress={() =>
                  showInDevelopmentAlert("Saving campaigns isnt available yet.")
                }
                className="w-14 h-14 rounded-2xl items-center justify-center"
                style={{ borderWidth: 2, borderColor: colors.border }}
              >
